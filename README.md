...
- **Promo Effectiveness** — Performance analysis of 12 distinct promo codes
...
### 1. 📋 Overview KPIs
20 executive-level metrics across 6 categories — Revenue, Volume, Customer, Product, Geography, and Operational Health.
...
📄 **[View Full Insights & Recommendations →](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Exploration%20and%20Analysis/Insights_and_Reccomendations.md)**
...
**Steps:**
1. Run [`init_database.sql`](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Queries/Database%20Schema%20Creation/init_database.sql) — creates the database and all three schemas
2. Update the file paths in [`Bronze_Layer/Script.sql`](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Queries/Bronze_Layer/Script.sql) to point to your local CSVs
3. Run scripts in order: Database Schema → Bronze → Silver → Gold
4. **Or** run [`One_Click_Procedure/Script.sql`](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Queries/One_Click_Procedure/Script.sql) to execute the full pipeline in one shot
5. Run [`Analysis_code.sql`](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Exploration%20and%20Analysis/Analysis_code.sql) to generate all analytical outputs
...
| Resource | Link |
|----------|------|
| Database Initialization | [init_database.sql](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Queries/Database%20Schema%20Creation/init_database.sql) |
| Bronze Layer | [Bronze_Layer/Script.sql](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Queries/Bronze_Layer/Script.sql) |
| Silver Layer | [Silver_Layer/Script.sql](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Queries/Silver_Layer/Script.sql) |
| Gold Layer | [Gold_Layer/script.sql](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Queries/Gold_Layer/script.sql) |
| Pipeline Tests | [Pipeline_Tests/Tests.sql](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Queries/Pipeline_Tests/Tests.sql) |
| One-Click Pipeline | [One_Click_Procedure/Script.sql](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Queries/One_Click_Procedure/Script.sql) |
| Analysis Code | [Analysis_code.sql](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Exploration%20and%20Analysis/Analysis_code.sql) |
| Insights & Recommendations | [Insights_and_Recommendations.md](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Exploration%20and%20Analysis/Insights_and_Reccomendations.md) |
| Project Brief | [ShopSphere_Project_Brief](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/Project%20Brief/ShopSphere_Cohort7_Project_Brief.pdf) |

---

## 📖 Data Quality Notes

> **Known limitation — mobile app total mismatch:** The `is_total_mismatch` flag fires on 100% of mobile app transactions by design. The app's `gross_total` bakes in a promo discount that isn't stored as a separate column. The gap between `total_amount_usd` and `total_amount_recalc_usd` on app rows represents the estimated promo discount value. This is a source-system characteristic, not a pipeline defect.

---

## 📜 License

Licensed under the **MIT License** — see [LICENSE](https://github.com/Nte-Daniels/ShopSphere-Data-Warehouse-and-Analysis-Project/blob/main/LICENSE) for details.
